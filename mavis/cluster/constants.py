...
DEFAULTS.add(
    ...
    defn='the maximum cumulitive size of both breakpoints for breakpoint pairs to be used in the initial clustering '
    'phase (combining based on overlap)')
DEFAULTS.add(
    'cluster_radius', 100,
    defn='maximum distance allowed between paried breakpoint pairs')
DEFAULTS.add(
    'max_proximity', 5000,
