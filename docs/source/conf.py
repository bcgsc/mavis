...
latex_documents = [
    (master_doc, 'svmerge.tex', 'svmerge Documentation',
     'creisle', 'manual'),
]
...
man_pages = [
    (master_doc, 'svmerge', 'svmerge Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'svmerge', 'svmerge Documentation',
     author, 'svmerge', 'One line description of project.',
     'Miscellaneous'),
]
